        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-8">
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border-2 font-railregular border-primary-blue  rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
